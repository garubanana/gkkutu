...
exports.getPenalty = function(chain, score){
	return -1 * Math.round(Math.min(10 + (chain || []).length * 2.1 + score * 0.15, score)); // 게임 하는 사람: 이건 점수를 잃게 하는 양을 조절하는 공식이얌!
};
exports.setmscore = function(score){
	return -1 * score
};
...
exports.MISSION_ko = [ "가", "나", "다", "라", "마", "바", "사", "아", "자", "차", "카", "타", "파",
 "하" , "루" , "바" , "구" , "누" , "두" , "무" , "부" , "수" , "주" , "추" , "쿠" , "투" , "고" , "노" ,
 "도" , "로" , "모" , "보" , "소" , "오" , "조" , "초" , "코" , "토" , "포" , "호" , "기" , "니" , "디" ,
 "리" , "미" , "비" , "시" , "이" , "지" , "치" , "키", "피", "드" ,"히"];
 
exports.MISSION_en = [ "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m",
...
exports.KO_INJEONG = [
	...
	"SWK" , "CKR" , "SVN" , "PUBG", 
	"RID" , "DSB" , "HPT" , "NCN" , "ING" , "MOR", "WHY", "ATG",
	"ONE"
	
];
exports.EN_INJEONG = [
	"LOL" , "ISAAC" ,"GMD" , "HWA" , "MUL" 
];
exports.KO_THEME = [
	"30", "40", "60", "80", "90",
	"140", "150", "160", "170", "190",
